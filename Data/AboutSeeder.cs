    ...
    private static async Task SeedSectionsAsync(AppDbContext db)
    {
        ...
        var sections = new[]
        {
            new AboutSection
            {
                ...
                DescriptionTH = "Neediss ก่อตั้งขึ้นด้วยความมุ่งมั่นในการจัดหาเครื่องมือวัดคุณภาพสูงสำหรับอุตสาหกรรมไทย",
                DescriptionEN = "Neediss was founded with a commitment to providing high-quality measuring instruments for Thai industry.",
    ...
    private static async Task SeedHistoryAsync(AppDbContext db)
    {
        ...
        var history = new[]
        {
            new AboutCompanyHistory
            {
                ...
                DescriptionTH = "Neediss ก่อตั้งขึ้นด้วยทีมผู้เชี่ยวชาญด้านเครื่องมือวัดอุตสาหกรรม",
                DescriptionEN = "Neediss was established by a team of industrial measurement specialists.",
                Position     = "left",
                DisplayOrder = 1,
                IsActive     = true,
                CreatedAt    = DateTime.UtcNow,
